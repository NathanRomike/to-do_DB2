...
--
-- Name: categories_tasks_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Guest
--

ALTER TABLE ONLY categories_tasks
    ADD CONSTRAINT categories_tasks_category_id_fkey FOREIGN KEY (category_id) REFERENCES categories(id);


--
-- Name: categories_tasks_task_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Guest
--

ALTER TABLE ONLY categories_tasks
    ADD CONSTRAINT categories_tasks_task_id_fkey FOREIGN KEY (task_id) REFERENCES tasks(id);
